...
function recalculate() {
    ...
    // Set the innerHTML of calculated-cost element to the new total cost
...
function changeDuration() {
    ...
    duration = parseFloat(newDuration); // assuming the input is a valid number
